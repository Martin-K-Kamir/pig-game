...
parcelHelpers.export(exports, "controlResettingTheGame", ()=>controlResettingTheGame
);
...
const controlRollingDice = function() {
    ...
    if (_gameViewJsDefault.default.clickOnce) {
        _gameViewJsDefault.default.disabledBtns(_configJs.BTN_WOKRING, _gameViewJsDefault.default.gameBtns);
        _gameViewJsDefault.default.clickOnce = _configJs.CLICK_UNAVAILABLE;
    }
...
},{"./model.js":"Y4A21","./views/themesView.js":"9sRV8","./views/gameView.js":"2oHQ0","./views/pauseView.js":"du5KE","./views/soundsView.js":"85ppV","./views/leavingView.js":"hzjSs","./views/menuView.js":"lg0TE","./views/View.js":"5cUXS","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"9sRV8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View.js":"5cUXS","../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2oHQ0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _model = require("../model");
var _soundsView = require("./soundsView");
var _soundsViewDefault = parcelHelpers.interopDefault(_soundsView);
...
class GameView extends _viewDefault.default {
    ...
    clickOnce = _configJs.CLICK_AVAILABLE;
    startTimerOnce = _configJs.CLICK_AVAILABLE;
    ...
    _handleSwapping() {
        this.body.addEventListener('click', (function(e) {
            ...
            if (btn.classList.contains('btn--swap-yes') || btn.classList.contains('btn--swap-yes-phone') || btn.classList.contains('btn--swap-yes-invisible')) {
                _model.swapScores();
                this._updateSwappedScores(..._model.state.scores);
                this.displaySwapBtns(_configJs.HIDE_BTNS);
                _soundsViewDefault.default.play(_soundsViewDefault.default.soundSwapped);
            }
    ...
    handleVictoryBar(handler) {
        this.body.addEventListener('click', (function(e) {
            ...
            if (btn.classList.contains('btn--back')) {
                _menuViewDefault.default.displayMenuWindow();
                this.addClass(this.timerBox);
                //handler(); // BUG: Opened dev tools in chrome returns undefined
                _controller.controlResettingTheGame() // Fixes the error
                ;
            }
        }).bind(this));
    }
    addHandlerInitGameTimer(handler, btn) {
        ...
        btn.addEventListener('click', (function() {
            if (this.startTimerOnce) {
                handler();
                this.startTimerOnce = _configJs.CLICK_UNAVAILABLE;
            }
        }).bind(this));
    }
    resetGameEls() {
        ...
        this.clickOnce = _configJs.CLICK_AVAILABLE;
        this.startTimerOnce = _configJs.CLICK_AVAILABLE;
        ...
        this._timerNums.textContent = '02:00';
    ...
    displayWinner(activePlayer, draw, playingVsRobot) {
        ...
        if (!draw && playingVsRobot) {
            document.querySelector(`.player--${activePlayer}`).classList.add('player--winner');
            document.querySelector(`.player__winner--${activePlayer}`).classList.remove('hidden');
            if (_model.state.scores[_configJs.PLAYER] > _model.state.scores[_configJs.ROBOT]) {
                this._victoryHeadingStart.textContent = `Congratulations`;
...
},{"./View":"5cUXS","../model":"Y4A21","./soundsView":"85ppV","./menuView":"lg0TE","../controller":"aenu9","../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"85ppV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lg0TE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","./gameView.js":"2oHQ0","../model.js":"Y4A21","../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"du5KE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hzjSs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire0426")
