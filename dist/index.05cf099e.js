...
class View {
    ...
    elToggleClass(el, className1 = 'hidden') {
        el.classList.toggle(className1);
    }
    addClass(el1, className2 = 'hidden') {
        el1.classList.add(className2);
    }
    removeClass(el2, className3 = 'hidden') {
        el2.classList.remove(className3);
    }
}
...
class GameView extends _viewJsDefault.default {
    ...
    addHandlerInitGameTimer(handler1, btn) {
    ...
    playerTimerCounting(activePlayer1) {
        this._playerTimerNum = 10; // 10 secs
        const updatePlayerTimer = ()=>{
            document.querySelector(`.player__playing--${activePlayer1}`).textContent = `playing for ${this._playerTimerNum} sec`;
...
},{"./View.js":"9dvKv","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["kS06O","lA0Es"], "lA0Es", "parcelRequire0426")
